  ...
  const groups = [
    {
      ...
      missing: [],
      alternatives: ['public-demo', 'shared-access-token'],
...
function accessPreflight(configured) {
  ...
  return {
    status: 'fallback',
    detail: 'Workspace routes are open for the public demo; set WORKSPACE_ACCESS_TOKEN only for a private deployment.',
  };
}
